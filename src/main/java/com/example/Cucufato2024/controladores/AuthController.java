...
import com.example.Cucufato2024.servicios.impl.ServicioEmpresaImpl;
...
public class AuthController {
    ...
    @Autowired
    private ServicioEmpresaImpl servicioEmpresa;
    ...
    public String showRegistrationForm(Model model){
        ...
        model.addAttribute("empresas", servicioEmpresa.findAll()); // Las empresas para el select para Multipropiedad
